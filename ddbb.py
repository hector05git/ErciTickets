...
# ssh_port = 11080  # Puerto SSH
# ssh_username = 'sshuser'  # Nombre de usuario SSH
# ssh_private_key_path = "C:\\Users\\hecto\\Desktop\\acceso remoto\\accesso remoto pve\\id_rsa"  # Ruta de la clave privada RSA
...
db_name = 'erictickets'  # Nombre de la base de datos PostgreSQL
...
def get_db_connection():
    ...
    db_connection = psycopg2.connect(  # Establece la conexión a la base de datos PostgreSQL
        ...
        port=5432,  # Puerto local al que se ha reenviado el tráfico
